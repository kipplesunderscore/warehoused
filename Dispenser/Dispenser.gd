...
var grape =	preload("res://Box/Grape.tscn")
var apple = preload("res://Box/Apple.tscn")
var melon = preload("res://Box/Melon.tscn")
var bolt = preload("res://Box/Bolt.tscn")
var fabric = preload("res://Box/Fabric.tscn")
