...
var possible_boxes = [
    preload("res://src/Box/Grape.tscn"),
    preload("res://src/Box/Apple.tscn"),
    preload("res://src/Box/Melon.tscn"),
    preload("res://src/Box/Bolt.tscn"),
    preload("res://src/Box/Fabric.tscn")
]
